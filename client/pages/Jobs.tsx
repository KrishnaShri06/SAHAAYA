...
import { Briefcase, MapPin, Clock, DollarSign, User, Building, Search, Filter, Plus, Heart, Globe } from 'lucide-react';
...
export default function Jobs() {
  ...
  const mockJobs = [
    {
      ...
      description: "Join our diverse team providing customer support. Training provided. Multiple languages welcome.",
    ...
    },
    {
      ...
      posted: "1 day ago",
      refugee_friendly: true,
      description: "Entry-level position in busy kitchen. Will train. Great for gaining local work experience.",
    ...
    },
    {
      ...
      posted: "3 days ago",
      refugee_friendly: true,
      description: "Seeking interpreters for multiple languages. Medical interpretation experience preferred.",
    ...
    },
    {
      ...
      posted: "5 days ago",
      refugee_friendly: false,
      description: "Physical warehouse work including loading, unloading, and inventory management.",
    ...
    },
    {
      ...
      posted: "1 week ago",
      refugee_friendly: true,
      description: "Help other refugees navigate services and programs. Personal experience valued.",
  ...
  const filteredJobs = mockJobs.filter(job => {
    ...
    const matchesRefugeeFriendly = !searchFilters.refugee_friendly || job.refugee_friendly;
    
    return matchesKeyword && matchesLocation && matchesType && matchesRefugeeFriendly;
  });
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Job & Skill Match</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Connecting refugees and displaced persons with meaningful employment opportunities and skill-based work.
            </p>
          </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="flex items-end">
                      <div className="w-full">
                        <Label htmlFor="refugee-friendly" className="flex items-center gap-2">
                          <input
                            id="refugee-friendly"
                            type="checkbox"
                            checked={searchFilters.refugee_friendly}
                            onChange={(e) => setSearchFilters(prev => ({ ...prev, refugee_friendly: e.target.checked }))}
            ...
            <div className="max-w-2xl mx-auto">
              <Card className="shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>
                    Build a comprehensive profile to match with the right opportunities
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleProfileCreation} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        <Label htmlFor="profile-location">Current Location</Label>
                        <Input
                          id="profile-location"
                    ...
                    <div>
                      <Label htmlFor="profile-authorization">Work Authorization Status</Label>
                      <select
                        id="profile-authorization"
                        value={profileForm.work_authorization}
                        onChange={(e) => setProfileForm(prev => ({ ...prev, work_authorization: e.target.value }))}
                        className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                        required
                      >
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="part-time">Part-time (less than 30 hours/week)</option>
            ...
            <div className="max-w-2xl mx-auto">
              <Card className="shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>
                    Help refugees and displaced persons by posting inclusive job opportunities
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleJobPost} className="space-y-6">
                    ...
                    <div>
                      <Label htmlFor="job-requirements">Requirements & Skills</Label>
                      <Textarea
                        id="job-requirements"
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) => setJobForm(prev => ({ ...prev, refugee_friendly: e.target.checked }))}
                        className="rounded border-gray-300"
                      />
                      <Label htmlFor="refugee-friendly-post" className="flex items-center gap-2">
                        <Globe className="h-4 w-4" />
                        This is a refugee-friendly position
                      </Label>
                    </div>
                    <p className="text-sm text-gray-600">
                      Check this if your company welcomes refugees, provides training, or has support for immigrants.
                    </p>
