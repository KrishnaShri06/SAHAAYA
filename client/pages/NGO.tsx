...
import { Building2, Users, Heart, Package, MapPin, Calendar, Star, Phone } from 'lucide-react';
  ...
  const mockAidRequests = [
    {
      ...
      description: "Urgent need for medical supplies and trained volunteers to assist flood victims.",
      posted: "2 hours ago"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description: "Need volunteers to help set up temporary housing facilities.",
      posted: "1 day ago"
    }
  ];
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-4">NGO Coordination</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Connect NGOs, coordinate aid requests, and manage volunteer resources for effective crisis response.
            </p>
          </div>
                    ...
                    <form onSubmit={handleAidRequest} className="space-y-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setAidRequest(prev => ({ ...prev, title: e.target.value }))}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setAidRequest(prev => ({ ...prev, organization: e.target.value }))}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setAidRequest(prev => ({ ...prev, location: e.target.value }))}
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) => setAidRequest(prev => ({ ...prev, urgency: e.target.value }))}
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) => setAidRequest(prev => ({ ...prev, category: e.target.value }))}
                            className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                            required
                          >
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setAidRequest(prev => ({ ...prev, volunteers_needed: e.target.value }))}
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) => setAidRequest(prev => ({ ...prev, description: e.target.value }))}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setAidRequest(prev => ({ ...prev, contact: e.target.value }))}
            ...
            <div className="max-w-2xl mx-auto">
              <Card className="shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>
                    Join our volunteer network and help coordinate crisis response efforts
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleVolunteerRegistration} className="space-y-6">
                    ...
                    <div>
                      <Label htmlFor="vol-experience">Previous Experience</Label>
                      <Textarea
                        id="vol-experience"
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-600">{ngo.volunteers} volunteers</span>
                      </div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button size="sm" variant="outline" className="flex-1">Partner</Button>
                    </div>
                  </CardContent>
                </Card>
              ))}
